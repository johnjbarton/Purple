...
5. Input the URL to Purple/index.html in your clone. On orionhub this will be something like http://orionhub.org/file/XX/index.html, where XX is a code for your clone.
6. Save the URL. 
