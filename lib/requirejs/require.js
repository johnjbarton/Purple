            ...
            if (cb && isFunction(cb)) {
                ...
                if (ary) {
                    for (i = 0; i < ary.length; i++) {
                        if(req.jsExtRegExp.test(ary[i])) {  // then plain js file may result in undefined
                          continue;
                        }
                        var dependency = manager.deps[ary[i]];
                        if (false && req.onDebug && typeof(dependency) === "undefined") {
        ...
        function main(inName, depArray, callback, relModuleMap) {
            ...
            for (i = 0; i < depArray.length; i++) {
                ...
                if (depArg) {
                    ...
                    console.log("requirejs loading "+(fullName ||inName)+" dependency: "+depArray[i]+' resolves to '+depName);
                    depArray[i] = depName;
                ...
                if (req.jsExtRegExp.test(moduleName)) {
                    ...
                    for (i = syms.length; i > 0; i--) {
                        ...
                        if (paths[parentModule]) {
                            console.log("paths["+parentModule+"]="+paths[parentModule]);
                    ...
                    if ( url.charAt(0) !== '/' && ! url.match(/^\w+:/) ) {
                        ...
                        console.log("url rebased "+config.baseURL+" + "+url);
