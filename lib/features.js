...
(function (){
 ...
 /* 
  thePurple.Features.partAdded = function(partInfo) {
    if (partInfo.value === this) {
      ...
      thePurple.Features.partAdded = function(changeInfo) {
        console.log("Features got a new part", changeInfo);
  ...
  thePurple.Features.partRemoved = function(feature) {
    if (feature.value === this) {
      var models = thePurple.getPartByName('models');
      var purpleModel = models.getPartByName('purple.parts');
